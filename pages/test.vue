...
// 掛號日期選單
const dateSelectContent = ref(null)
const dateSelectOption = [
    {name: '114/02/19', value:'114/02/19' },
    {name: '114/02/18', value:'114/02/18' },
    {name: '114/02/17', value:'114/02/17' }
]
        ...
        <div class=" bg-orange-100 w-full p-2">
            <div class="grid grid-cols-16">
                ...
                <div class="col-span-9 flex flex-row items-center gap-2">
                    ...
                    <Select v-model="dateSelectContent" :options="dateSelectOption" optionLabel="name" placeholder="掛號日期" class="w-full md:w-56" size="small"/>
